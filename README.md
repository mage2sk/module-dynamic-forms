<!-- SEO Meta -->
<!--
  Title: Magento 2 Dynamic Forms Extension: Drag-and-Drop Form Builder | Hyva + Luma | Panth Infotech
  Description: Panth Dynamic Forms lets you build unlimited custom forms in Magento 2 with a drag-and-drop field builder, 13 field types, AJAX submission, email notifications with auto-reply, a submission management grid, and a widget to embed forms anywhere. Native Hyva (Alpine.js) and Luma templates. Works on Magento 2.4.4 to 2.4.8 and PHP 8.1 to 8.4. Built by Top Rated Plus Magento developer Kishan Savaliya.
  Keywords: magento 2 dynamic forms, magento 2 form builder, magento 2 custom forms, magento 2 contact forms, magento 2 survey forms, drag and drop form builder magento 2, hyva form builder, luma form builder, magento 2 form widget, magento 2 form submissions, magento 2 auto reply email, magento 2 file upload form
  Author: Kishan Savaliya (Panth Infotech)
  Canonical: https://kishansavaliya.com/magento-2-dynamic-forms.html
-->
...
[![Live Demo & Details](https://img.shields.io/badge/Live%20Demo%20%26%20Details-magento--2--dynamic--forms-0D9488?style=flat)](https://kishansavaliya.com/magento-2-dynamic-forms.html)
...
### File Upload
- **Files are stored under `pub/media`** (directory is configurable).
- **MIME whitelist and max file size** are enforced both globally and enforced by `Panth\Core\Security\UploadExtensionPolicy` on the server side.
- **Executable types** (php, phtml, sh, jsp, and others) are blocked by a hard deny-list independent of admin settings.
...
- **Custom URL key** per form (e.g. `/pages/contact-us`).
- **Meta title, description, keywords, and robots** configurable per form.
...
- **Layout XML support** if you prefer to embed via `<referenceContainer>`.
- **CMS shortcode** works in WYSIWYG editor too.
...
- **Custom colors and border radius** can be set globally or pulled from Hyva's `theme-config.json`.
...
- **Multi-store scoped** settings at default, website, and store view level.
...
| Email | Email address input | Required, RFC email format |
...
1. Download the latest release from [Packagist](https://packagist.org/packages/mage2kishan/module-dynamic-forms) or from the [product page](https://kishansavaliya.com/magento-2-dynamic-forms.html).
2. Extract it to `app/code/Panth/DynamicForms/` in your Magento install.
...
| Setting | Group | Default | Description |
|---|---|---|---|
| Admin Notification Template | Email | Default | Email template for admin alerts when a form is submitted. |
| Admin Notification Sender | Email | General Contact | Sender identity used for admin notification emails. |
| Auto-Reply Template | Email | Default | Email template sent to the submitter as a confirmation. |
| Auto-Reply Sender | Email | General Contact | Sender identity used for auto-reply emails. |
...
8. Review all submissions under **Admin -> Panth Infotech -> Dynamic Forms -> Form Submissions**.
...
<p align="center">
  ...
  &nbsp;&nbsp;
  <a href="https://kishansavaliya.com/magento-2-dynamic-forms.html">
    <img src="https://img.shields.io/badge/View%20Product%20Page-magento--2--dynamic--forms-0D9488?style=for-the-badge" alt="View Product Page" />
  </a>
</p>
...
| Resource | Link |
|---|---|
| **Product Page** | [magento-2-dynamic-forms.html](https://kishansavaliya.com/magento-2-dynamic-forms.html) |
...
<p align="center">
  <strong>Ready to collect customer data without writing code?</strong><br/>
  <a href="https://kishansavaliya.com/magento-2-dynamic-forms.html">
    <img src="https://img.shields.io/badge/%F0%9F%9A%80%20See%20Dynamic%20Forms%20%E2%86%92-Product%20Page%20%26%20Demo-DC2626?style=for-the-badge" alt="See Dynamic Forms" />
  </a>
</p>
