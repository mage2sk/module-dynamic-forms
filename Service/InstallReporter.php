<?php
/**
 * Standalone install + heartbeat reporter for Panth_DynamicForms.
 *
...
namespace Panth\DynamicForms\Service;
...
{
    public const MAGENTO_MODULE = 'Panth_DynamicForms';
    public const COMPOSER_PACKAGE = 'mage2kishan/module-dynamic-forms';
